            ...
            <div class="media">
              ...
              <div class="media-body">
                <ul class="ml-4 px-0 list-unstyled">
                  <li class="text-bold-800">Innology Solution CMS</li>
                  <li>Pulchowk</li>
                  <li>Lalitpur,</li>
                  <li>Nepal</li>
                </ul>
        ...
        <div id="invoice-footer">
          <div class="row">
            ...
            <div class="col-md-5 col-sm-12 text-center">
              <a target="_blank" :href="this.$root.baseUrl + '/invoice'" download class="btn btn-primary btn-lg my-1"><i class="fa fa-paper-plane-o"></i> Send Invoice</a>
            </div>
          </div>
        </div>
        <!--/ Invoice Footer -->
